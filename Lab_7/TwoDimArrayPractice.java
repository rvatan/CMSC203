...
public class TwoDimArrayPractice extends JFrame{
   ...
   */
   public void printArray( )
   {
    ...
    // Write your code here:
	   ...
	   System.out.println("Row" + "\tValues of Printed Array");
	   for (int row=0; row < intArray.length; row++) {
		   System.out.print(row + "\t");
		   for (int column=0; column < intArray[row].length; column++) {
   ...
   public void setValues( int value, int row )
   {
    ...
    // Write your code here:
	   for (int rowNum=0; rowNum<intArray.length; rowNum++) {
		   for (int column=0; column<intArray[rowNum].length; column++) {
			   if (rowNum == row) {
				   intArray[rowNum][column] = value;
				   animate( rowNum, column ); 
			   }
		   }
	   }
   }
   ...
   */
   public int findMinimum( int column )
   {
    ...
    // Write your code here:
	   int minValue = intArray[0][0];
	   for (int rowNum=0; rowNum<intArray.length; rowNum++) {
		   if (intArray[rowNum][column]<minValue) {
			   minValue = intArray[rowNum][column];
			   animate( rowNum, column, minValue );
		   }
	   }
